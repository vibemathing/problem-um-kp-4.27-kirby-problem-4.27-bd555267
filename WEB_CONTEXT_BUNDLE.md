...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.27-kirby-problem-4.27-bd555267-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.27"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.27-kirby-problem-4.27-bd555267-v1",
      "problem_contract_sha256": "f1373614eed5fe9dc0a07d779a012831c6fcc6eb272a09aac7c12c25a5154c66",
      "problem_id": "problem:um-kp-4.27-kirby-problem-4.27-bd555267",
      "route_id": "route:um-kp-4.27-kirby-problem-4.27-bd555267-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.27-kirby-problem-4.27-bd555267-source-fidelity-01",
      "graph_id": "graph:um-kp-4.27-kirby-problem-4.27-bd555267-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.27-kirby-problem-4.27-bd555267-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.27-kirby-problem-4.27-bd555267-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Find exotic 3-balls in $S^{4}$, considered up to isotopy rel. boundary. That is, find a pair of 3-balls $B_{1}, B_{2}$ smoothly embedded in $S^{4}$ with the same boundary such that $B_{1}, B_{2}$ are topologically but not smoothly isotopic rel. boundary."
          },
          "statement_sha256": "b509d0ea9e8ea75742c7935ffabdc8d79b42c9fadbab488aaaa3859051f2ab9b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.27-kirby-problem-4.27-bd555267-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.27-kirby-problem-4.27-bd555267-root",
      "route_id": "route:um-kp-4.27-kirby-problem-4.27-bd555267-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.27-b682d5c1de6b",
        "url": "https://www.unsolvedmath.com/problems/KP-4.27"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
